...
class Motors:
    ...
    def reverse_left(self):
        self.reverse_left_with_duty_cycle(left_duty_cycle = percentage(OUTWARD_MOTOR_LEAN_DUTY_CYCLE_PERCENTAGE, self.desired_left_duty_cycle), 
    ...
    def right(self):
        self.right_with_duty_cycle(left_duty_cycle = percentage(INWARD_MOTOR_LEAN_DUTY_CYCLE_PERCENTAGE, self.desired_left_duty_cycle), 
            right_duty_cycle = percentage(OUTWARD_MOTOR_LEAN_DUTY_CYCLE_PERCENTAGE, self.desired_right_duty_cycle)
        )
